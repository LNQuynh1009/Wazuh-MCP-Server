...
async def async_claude_classify_alert(alert):
    """Call Claude to analyze alert and return structured JSON (async)."""
    if AsyncAnthropic is None or not CLAUDE_API_KEY:
